...
require_regex 'function openBinaryViewer\(uid\)[[:space:]]*\{'
require_regex 'function closeBinaryViewer\(\)[[:space:]]*\{'
require_regex 'function renderBinaryView\(\)[[:space:]]*\{'
...
require_text 'id="binary-overlay"'
require_text 'onclick="openBinaryViewer('
