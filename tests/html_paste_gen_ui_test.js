...
const finishSource = extractFunctionSource(appScript, 'finishStructureResize');
const initializeSource = extractFunctionSource(appScript, 'initializeStructureResizer');
...
assert.match(initializeSource, /addEventListener\(\s*["']pointerdown["']\s*,\s*startWorkspaceResize\s*\)/);
assert.match(initializeSource, /pointermove/);
assert.match(initializeSource, /addEventListener\(\s*["']pointerup["'][\s\S]*finishStructureResize/);
assert.match(initializeSource, /addEventListener\(\s*["']pointercancel["'][\s\S]*finishStructureResize/);
